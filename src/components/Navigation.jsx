        ...
        <nav className="bg-slate-900 p-4 fixed w-full z-50">
            <div className="container mx-auto flex justify-between items-center">
                ...
                >
                    ...
                    <Link to="/#about" className="text-gray-300 hover:text-cyan-400 flex items-center gap-2">
                        <FiUser /> Sobre mí
                    </Link>
                    <Link to="/#contact" className="text-gray-300 hover:text-cyan-400 flex items-center gap-2">
                        <FiMail /> Contacto
                    </Link>
                </div>
